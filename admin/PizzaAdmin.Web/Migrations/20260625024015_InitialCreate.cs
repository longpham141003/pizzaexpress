        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesktopImagePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    MobileImagePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenNewTab = table.Column<bool>(type: "INTEGER", nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GtmId = table.Column<string>(type: "TEXT", nullable: true),
                    GoogleAdsId = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    FooterBgImagePath = table.Column<string>(type: "TEXT", nullable: true),
                    PrivacyPolicyUrl = table.Column<string>(type: "TEXT", nullable: true),
                    ReturnPolicyUrl = table.Column<string>(type: "TEXT", nullable: true),
                    PaymentPolicyUrl = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SinglePrice = table.Column<decimal>(type: "TEXT", nullable: true),
                    SingleSalePrice = table.Column<decimal>(type: "TEXT", nullable: true),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeName = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    SizeLabel = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
